...
fn generate(
    ...
    if dry_run {
        ...
        if *split == SplitMode::Tag {
            ...
            let mut tag_index = String::from("// Generated by oa-forge. Do not edit.\n");
            ...
            // Replace the root index with the tag-aware version
